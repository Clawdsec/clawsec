...
describe('BeforeAgentStartHandler', () => {
  ...
  describe('Edge cases', () => {
    ...
    it('should handle empty sessionId gracefully by generating one', async () => {
      ...
      expect(result.systemPromptAddition).toBeDefined();
      expect(result.systemPromptAddition).toContain('Work safely within these protections');
    });
  });
  ...
  describe('Session State Tracking', () => {
    it('should inject context only once per session', async () => {
      ...
      expect(result1.systemPromptAddition).toContain('CLAWSEC SECURITY CONTEXT');
      expect(result1.systemPromptAddition).toContain('Work safely within these protections');
    ...
    it('should inject context for different sessions', async () => {
      ...
      expect(result2.systemPromptAddition).toContain('CLAWSEC SECURITY CONTEXT');
    });
    ...
    it('should track sessions even with generated sessionIds', async () => {
      ...
      expect(result3.systemPromptAddition).toBeDefined();
    });
  });
});
